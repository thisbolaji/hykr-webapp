      ...
      <section className="py-16 px-6 bg-[#f5fbff]">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-6xl mx-auto">
          ...
          <div className="bg-white rounded-xl shadow-lg p-8 flex flex-col items-center space-y-4">
            ...
            <span className="text-xs uppercase tracking-wide text-muted-foreground">Rider</span>
          </div>
          {/* Testimonial 2 */}
          <div className="bg-white rounded-xl shadow-lg p-8 flex flex-col items-center space-y-4">
            <Quote className="w-10 h-10 text-hykr-blue mb-2" />
            ...
            <span className="text-xs uppercase tracking-wide text-muted-foreground">Family Traveler</span>
          </div>
          {/* Testimonial 3 */}
          <div className="bg-white rounded-xl shadow-lg p-8 flex flex-col items-center space-y-4">
            <Quote className="w-10 h-10 text-hykr-blue mb-2" />
            ...
            <span className="text-xs uppercase tracking-wide text-muted-foreground">Frequent Traveler</span>
          </div>
        </div>
      </section>
