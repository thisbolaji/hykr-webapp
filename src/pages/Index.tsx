...
const Index = () => {
  ...
  return (
    <div className="min-h-screen flex flex-col bg-white">
      ...
      {/* Hero Section */}
      <section className="py-16 md:py-24 px-6 bg-gradient-to-b from-secondary to-white">
        <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
          <div className="space-y-6 animate-slide-up">
            ...
            <div className="pt-4 flex flex-col sm:flex-row space-y-4 sm:space-y-0 sm:space-x-4">
              <Button 
                size="lg" 
                className="bg-primary hover:bg-hykr-teal-dark transition-colors text-lg"
                onClick={() => navigate("/login")}
              >
                Book a Ride
              </Button>
          ...
          <div className="relative animate-fade-in hidden md:block">
            ...
            <div className="absolute -bottom-10 -right-10 w-64 h-64 bg-hykr-green/20 rounded-full filter blur-3xl"></div>
            <div className="relative rounded-lg overflow-hidden shadow-2xl">
              <img 
                src="https://images.unsplash.com/photo-1639313877762-4e1099ec9fe7?q=80&w=1400&fit=crop" 
                alt="Eco-friendly car on city street" 
                className="w-full h-auto object-cover rounded-lg"
              />
              <div className="absolute bottom-0 left-0 right-0 bg-gradient-to-t from-black/70 to-transparent p-6">
                <div className="text-white text-lg font-medium">Reduce carbon footprint with every ride</div>
              </div>
            </div>
          </div>
        </div>
      ...
      {/* CTA Section */}
      <section className="py-16 px-6 bg-gradient-to-r from-primary/20 to-hykr-green/20">
